    ...
    <md-content>
      <div class='login-container'>
        ...
        <div class='input-container'>
          ...
          <input type='text' id='input-password' class='input-text' placeholder='Password'/>
        </div>
        <span class='forget-password'>Forget your password ?</span>
        <router-link to='/' id='btn-login' class='btn'>Login</router-link>
        <router-link to='/register' id='btn-register' class='btn'>Register</router-link>
